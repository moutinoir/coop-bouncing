...
public class ZKLTree
{
	private List<ZKLTree> branches;
	private GameObject contents;
	private GameObject appearance;
	private ZKLTree lParent;
	...
	public void construct(GameObject parentTree, float length, float radius)
	{
		...
		appearance = GameObject.CreatePrimitive(ZKLTreeController.limbType);
		...
		appearance.transform.Translate(0,0.5f*ZKLTreeController.yScale*length,0);
		createChildren();
	}
